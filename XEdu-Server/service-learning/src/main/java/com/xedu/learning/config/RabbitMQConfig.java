package com.xedu.learning.config;
...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding binding_queue_media_processtask_1(@Qualifier(XC_LEARNING_ADDCHOOSECOURSE) Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
